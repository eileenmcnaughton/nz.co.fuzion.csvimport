...
<div class="crm-block crm-form-block crm-import-mapfield-form-block">
  ...
  <div id="help">
    ...
    {if $savedMapping}
    <p>{ts}Click 'Load Saved Field Mapping' if data has been previously imported from the same source. You can then
      select the saved import mapping setup and load it automatically.{/ts}<p>
      {/if}
